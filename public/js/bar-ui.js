    ...
    function makeSound(url) {
      ...
      var sound = soundManager.createSound({
        ...
        onplay: function() {
          ...
          console.log("played! episode_id: " + dom.episodeData.episode.id);
          Vue.http.headers.common['X-CSRF-TOKEN'] = document.querySelector('#token').getAttribute('value');
          Vue.http.post('/api/episode/play', {episode_id: dom.episodeData.episode.id}, status);
          callback('play');
        },
        ...
        onfinish: function() {
          ...
          console.log("finished! episode_id: " + dom.episodeData.episode.id);
          Vue.http.headers.common['X-CSRF-TOKEN'] = document.querySelector('#token').getAttribute('value');
          Vue.http.post('/api/episode/finish', {episode_id: dom.episodeData.episode.id}, status);
