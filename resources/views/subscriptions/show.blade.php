                ...
                <div class="col-md-12">
                    <div class="portlet light portlet-fit bordered">
                        <div class="portlet-title">
                            <div class="caption">
                                <span class="caption-subject font-black bold uppercase">Inscrições</span>
                            </div>
                        </div>
                                    ...
                                    <li>
                                        <div class="mt-card-item">
                                            ...
                                            <div class="mt-card-content">
                                                ...
                                                ?>
                                                <h5 class="mt-card-name">{{ link_to($episode->program->slug."/".$episode->slug, $title = $episode->title, $attributes = array(), $secure = null) }}</h5>
